...
#define NDEF_MAX_SIZE								M24SR64_NDEF_MAX_SIZE
...
#define ReadPrivateData							M24SR_ReadPrivateData
#define WritePrivateData						M24SR_WritePrivateData
